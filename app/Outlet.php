...
class Outlet extends Model
{
    ...
    public function getMapPopupContentAttribute()
    {
        ...
        $mapPopupContent .= '<div class="my-2"><a href="outlets/'.$this->id.'"><strong>'.__('outlet.action').'</strong></a><br>'.''.'</div>';
        $mapPopupContent .= '<div class="my-2"><strong>'.__('outlet.coordinate').':</strong><br>'.$this->coordinate.'</div><br>';
        $mapPopupContent .= '<div class="my-2">'.$this->created_at.'</div>';
